with open(r'lab_11\bai_06\matrix.txt', 'w') as f:
    f.write("4\n")
    f.write("211 133 180 5\n")
    f.write("192 168 1 254\n")
    f.write("11 1 11 233\n")
with open(r'lab_11\bai_06\matrix.txt', 'r') as f:
...
with open(r'lab_11\bai_06\ODD.txt', 'w') as f_odd:
    for hang in matrix:
        f_odd.write(' '.join(hang) + '\n')
# d.
with open(r'lab_11\bai_06\ODD.txt', 'r') as f_odd:
