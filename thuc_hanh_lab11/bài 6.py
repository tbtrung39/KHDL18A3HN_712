with open('solaso.txt', 'w') as f:
    f.write("4\n")
    f.write("211 133 180 5\n")
    f.write("192 168 1 254\n")
    f.write("11 1 11 233\n")
with open('solaso.txt', 'r') as f:
    cac_dong = f.readlines()
# a. 
print("a. dong dau lan:", cac_dong[0].strip())
print("a. dong ba la:", cac_dong[2].strip())
# b. 
print("\nb. cac ndung trong bangso.txt:")
