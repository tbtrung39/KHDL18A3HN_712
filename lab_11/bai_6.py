...
#a
print("Dong dau tien la:", cac_dong[0].strip())
print("Dong thu ba la:", cac_dong[2].strip())

#b 
print("\nCac noi dung trong bangso.txt:")
...
with open('ODD.txt', 'r') as f_odd:
    ...
    print("\nDong cuoi cung cua ODD.txt la:", cac_dong_odd[-1].strip())